...
def add_to_dict(dict_name,key="",value=""):
  ...
  if str(type(dict_name)) != "<class 'dict'>":
    print(f"You need to send a dictionary. You sent: {str(type(dict_name))}")
...
def update_word(dict_name,key="",value=""):
  ...
  if str(type(dict_name)) != "<class 'dict'>":
    ...
    dict_name[key] = value
    print(f"{key} has been updated to: {dict_name[key]}")

  
def delete_from_dict(dict_name,key=""):
  
  if str(type(dict_name)) != "<class 'dict'>":
    print(f"You need to send a dictionary. Your sent: {str(type(dict_name))}")
